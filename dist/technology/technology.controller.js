...
__decorate([
    ...
    (0, swagger_1.ApiResponse)({ status: common_1.HttpStatus.CREATED, description: 'Technology created', type: technology_model_1.TechResponse }),
...
__decorate([
    ...
    (0, swagger_1.ApiResponse)({ status: common_1.HttpStatus.OK, description: 'Technology updated', type: technology_model_1.TechResponse }),
    __param(0, (0, common_1.Body)()),
    __metadata("design:type", Function),
...
__decorate([
    ...
    (0, swagger_1.ApiResponse)({ status: common_1.HttpStatus.OK, description: 'Technology retrieved', type: technology_model_1.TechResponse }),
...
__decorate([
    ...
    (0, swagger_1.ApiResponse)({ status: common_1.HttpStatus.OK, description: 'Technologies retrieved', type: technology_model_1.TechResponse, isArray: true }),
    __metadata("design:type", Function),
...
__decorate([
    ...
    (0, swagger_1.ApiResponse)({ status: common_1.HttpStatus.OK, description: 'Technology deleted', type: Boolean }),
    __param(0, (0, common_1.Param)('techId')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String]),
    __metadata("design:returntype", Promise)
